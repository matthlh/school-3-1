...
|---|-------|-----|-------|------|-------|--------|------|-------|
| 1 | What SE is — "managing what a change costs" · changing requirements as the driver · code vs software · analytical code design | 1 | 2026-09-11 | 2026-09-18 | X | 0 | 2026-09-19 | reader: Intro + ACD intro |
