...
## Lec 1 — Overview of the "Authorship" (Fri Sep 11, logged 2026-09-11)

### Q: In what year did Hegel die, and what two camps did his followers split into afterwards? What separated them?
**Topic:** Post-Hegelian context  **Lec:** 1  **Type:** recall
**A:** 1831. His followers split into two camps over religion.
- Right (Old) Hegelians: the system is compatible with orthodox Christianity, a personal God and immortality.
- Left (Young) Hegelians (Strauss, Feuerbach, Bauer, later Marx): the system is incompatible with theism.

The right/left labels themselves come from this dispute. Strauss coined them in 1837.

### Q: Name the author, title and date of the book that set off the theological dispute over Hegel, and what it claimed about the Gospels.
**Topic:** Post-Hegelian context  **Lec:** 1  **Type:** recall
**A:** David Friedrich Strauss, *The Life of Jesus, Critically Examined* (*Das Leben Jesu*), 1835–36. It claimed the Gospel narratives are myth produced by the early Christian community, not history. It is a Left Hegelian reading.

### Q: Why did calling Hegel a pantheist amount to calling him an atheist in Germany, and how did Hegel describe his own religious position?
**Topic:** Post-Hegelian context  **Lec:** 1  **Type:** recall
**A:** Since the Pantheism Controversy of 1785 (Jacobi), pantheism, meaning God is the whole and there is no personal God, was treated as atheism in disguise. Critics said Hegel's Absolute Spirit is impersonal, so it is pantheism, so it is atheism. Hegel said he was and would remain a Lutheran, and presented his philosophy as Christian philosophy.

### Q: Title, year and subject of Kierkegaard's dissertation?
**Topic:** Kierkegaard 1841–43  **Lec:** 1  **Type:** recall
**A:** *On the Concept of Irony with Continual Reference to Socrates*, 1841 (defended 29 September). It was his master's (magister) dissertation at Copenhagen, on Socratic irony.

### Q: Who was called to Berlin in 1841 by the King of Prussia, what was the task in the king's own metaphor, and what did Kierkegaard have to do with it?
**Topic:** Kierkegaard 1841–43  **Lec:** 1  **Type:** recall
**A:** F. W. J. Schelling, called by Friedrich Wilhelm IV to "stamp out the dragon-seed of Hegelian pantheism". In plain terms: defend Christian philosophy against Hegelianism. Kierkegaard went to Berlin in October 1841 and attended the lectures over the winter of 1841–42. He was enthusiastic at first, then disappointed, and was back in Copenhagen by March 1842.

### Q: What was Kierkegaard's public debut as an author, in what year, and under whose name did it appear?
**Topic:** Kierkegaard 1841–43  **Lec:** 1  **Type:** recall
...
3. *Repetition* (1843)
4. *Philosophical Crumbs*, also called *Fragments* (1844)
5. *The Concept of Anxiety* (1844)
6. *Prefaces* (1844)
7. *Stages on Life's Way* (1845)
8. *Concluding Unscientific Postscript* (1846)

### Q: Match each pseudonym to its work: Victor Eremita, Johannes de silentio, Constantin Constantius, Johannes Climacus, Vigilius Haufniensis, Nicolaus Notabene, Hilarius Bookbinder.
**Topic:** First authorship: the 8 pseudonymous works  **Lec:** 1  **Type:** recall
**A:**
- Victor Eremita: *Either/Or* (as editor).
- Johannes de silentio: *Fear and Trembling*.
- Constantin Constantius: *Repetition*.
- Johannes Climacus: *Philosophical Crumbs* and the *Postscript*.
...
### Q: What did Kierkegaard publish under his own name during the first authorship, how many, and how did they relate to the pseudonymous books?
**Topic:** Pseudonymity and the 18 discourses  **Lec:** 1  **Type:** recall
**A:** Upbuilding (edifying) discourses. Eighteen of them, in six small volumes (1843–44), each issued alongside a pseudonymous book. They carry his own religious standpoint while the pseudonyms carry the alternative perspectives. He said "upbuilding" rather than sermons because he was not ordained.

### Q: Name the main works of the second authorship with years, and say which are signed and which are pseudonymous.
**Topic:** Second authorship  **Lec:** 1  **Type:** recall
**A:**
- *Works of Love* (1847): signed.
- *Christian Discourses* (1848): signed.
- *The Sickness unto Death* (1849): pseudonym Anti-Climacus, with "S. Kierkegaard" as editor.
- *Practice in Christianity* (1850): pseudonym Anti-Climacus, with "S. Kierkegaard" as editor.
- *The Point of View for My Work as an Author*: written 1848, published 1859.

The second authorship presents his own religious perspective, unlike the first.

### Q: Why does the second authorship centre on love, and what distinction does Works of Love draw between kinds of love?
**Topic:** Second authorship  **Lec:** 1  **Type:** recall
...
**Topic:** Kraal on The Unhappiest One  **Lec:** 3  **Type:** apply
...
## Lec 4 — Kierkegaard's life, and Kraal's reading of "The Unhappiest One" (Fri Sep 18, logged 2026-09-19 from a friend's notes)

### Q: Who was Regine Olsen, and what are the dates of the engagement, the break, and what she did afterwards?
**Topic:** Kierkegaard's family losses  **Lec:** 4  **Type:** recall
**A:** The woman Kierkegaard was engaged to, born 1822; they met in May 1837, when she was 15 and he 24. He proposed on 8 September 1840 and she accepted on 10 September. He returned the ring with a farewell letter on 11 August 1841, she refused to accept the break, and it was made final in person in October 1841, two weeks before he left for Berlin on 25 October to hear Schelling. She became engaged to Johan Frederik Schlegel, her former tutor, in 1843 and married him on 3 November 1847; he became governor of the Danish West Indies in 1855. They never spoke again after 1841 except on 17 March 1855, the day she sailed, when she stopped him in the street and wished him well; he died eight months later. His will left everything to her, because for him an engagement was as binding as a marriage; she declined it.

### Q: "Kierkegaard broke off the engagement because he did not want Regine to suffer from his depression." Is that the whole story?
**Topic:** Kierkegaard's family losses  **Lec:** 4  **Type:** critique
**A:** It is one of his own stated reasons and the one given in lecture, so it is safe as far as it goes. His journals say there was something spectral about him that no one could endure who had to see him every day, and the ring letter says he could not make a girl happy. But he gives two more reasons. One is a secret he felt he would have to confide to a wife and could not, his "thorn in the flesh", which he repeated to Boesen on his deathbed. The other is his religious task as an author, which Regine herself later named as the reason. He also deliberately played the cad so that she would break with him. "His melancholy" is correct; "only his melancholy" is not. And it was an engagement, never a marriage.

### Q: A set of lecture notes says Kierkegaard "had a brain hemorrhage as a child". Assess.
**Topic:** Kierkegaard's family losses  **Lec:** 4  **Type:** critique
**A:** No source records a childhood brain hemorrhage for Kierkegaard. The line runs two other facts together. His brother Søren Michael died at 12 in September 1819, when Søren was 6, after a collision in the schoolyard, and the injury is usually described as to the head. And a brain hemorrhage was one of the causes later proposed for Kierkegaard's own fatal illness in 1855, and rejected. The childhood story that does attach to him is a fall from a tree, which he himself blamed for his crooked back and which the medical writers doubt. What is documented is that he collapsed in the street in late September 1855 with his legs paralysed, was admitted to Frederiks Hospital on 2 October, and died there on 11 November 1855, aged 42, cause still disputed.

### Q: Name the first-authorship books in which the broken engagement is standardly read, and say in one clause each how it appears.
**Topic:** First authorship: the 8 pseudonymous works  **Lec:** 4  **Type:** recall
**A:** *Either/Or* (1843): "The Seducer's Diary" was read in Copenhagen as his own treatment of Regine and was meant to make him look like a scoundrel, while the Judge's marriage essays defend the life he could not enter. *Repetition* (October 1843): the young man finds he is already recollecting the girl instead of loving her and breaks with her; Kierkegaard rewrote the ending after learning in July 1843 that Regine was engaged. *Fear and Trembling* (same day): Abraham's willingness to sacrifice Isaac, and his faith in getting him back, is read as the sacrifice of Regine. *Stages on Life's Way* (1845): "Guilty?/Not Guilty?" quotes the August 1841 farewell letter almost word for word and has Quidam break his engagement because marriage would block the religious life.

### Q: Kraal compared the end of "The Unhappiest One" with Tolstoy's *On Life*. State the parallel and the two differences, and say whether there is any historical connection.
**Topic:** Kraal on The Unhappiest One  **Lec:** 4  **Type:** derive
**A:** The parallel: both say that a person whose life is located outside the present does not really live and therefore cannot really die. Tolstoy's *On Life* (1886–87) argues that true life exists only in the present, outside time, and that the fear of death is an illusion produced by mistaking one's temporal, animal existence for life; his sharpest line is that the thought of a future death is only the transfer into the future of a death already happening in the present. That is the twin of A's man who in a way cannot die because he has not lived. Two differences: Tolstoy has a positive doctrine, subject the animal self to reason and you live now, whereas A offers no cure and walks off; and Tolstoy's target is other-worldly religion that puts the good of life before birth or after death, not memory and hope. No connection: Tolstoy wrote thirty years after Kierkegaard died, there is no evidence he read this essay, and the comparison is Kraal's, not the literature's.

### Q: What did Kraal call the ending of "The Unhappiest One", what does the word mean, and what in the text does it name?
**Topic:** Kraal on The Unhappiest One  **Lec:** 4  **Type:** recall
**A:** A doxology: a short hymn of praise, the "Glory be to the Father" kind. It is Kraal's own label rather than a term from the literature, and it names the close of the address, where A hails the winner with a chain of honorific titles — emissary from the kingdom of sighs, elected favourite of suffering, apostle of sorrow, silent friend of pain, unhappy lover of memory — salutes him as the great unknown whose name he does not know, pronounces two opposite sets of wishes over him, and then reverses the title to "the happiest".

### Q: Kraal said the ending offers "not joy but comfort", and spoke of "the paradox of being victimised by the world". Put both in A's own words, and say which of Kraal's words are not in the text.
**Topic:** Kraal on The Unhappiest One  **Lec:** 4  **Type:** critique
**A:** A's word is not comfort but fortune, *Lykke*. Being the unhappiest is "a gift of fortune that no one can give himself", the fellowship promises to gather to envy his fortune, and earlier the reward for being sure of the title is that one need never fear good fortune. That is the paradox: the worst misfortune is a distinction the world cannot take away, which is why A corrects himself to "the happiest" and says language fails. "Victimised" is also not A's word. He says the unhappiest one has the whole world over against him as a single "Thou" with which he is in conflict, that the whole rest of the world is for him one person, misunderstanding, and that his lips smile at the world that misunderstands him. Kraal's "comfort" is a fair reading of what the four closing clauses do, since faith, hope and love are each cut down to something an aesthete can bear; on an MC option the words are the happiest, a gift of fortune, and envy.

### Q: "You can only be happy in the present." Where does A say this, and what is its status in the argument?
**Topic:** Kraal on The Unhappiest One  **Lec:** 4  **Type:** recall
**A:** He slips it in as a conditional while introducing the hoping and remembering individuals: they are unhappy in a sense "if otherwise it is only the person who is present to himself that is happy". He never argues for it. It is the premise the whole contest runs on: on A's view a person is happy only insofar as he is present to himself, so absence in past or future is what unhappiness is. That is why the objection that his definition is a stipulation bites exactly here.

### Q: Lecture notes say the unhappiest one is "unable to die, live, hate, or be strong". Give A's actual wording for each, and the pattern they share.
**Topic:** Kraal on The Unhappiest One  **Lec:** 4  **Type:** recall
**A:** Die and live are right: in a way he cannot die, for he has never lived; in a way he cannot live, for he is already dead. A does not say he cannot hate; he says he hates the world only because he loves it, and that he has no passion not because he lacks it but because in the same instant he has the opposite one. On strength, he is powerless not because he lacks strength but because his own strength makes him impotent. The pattern is that each capacity is cancelled by its own opposite, so he is never on one side of anything, which is the same symmetry as never young and never old.

## Reading: *Either/Or*, "Crop Rotation" (Sep 21–23; logged 2026-09-21)

### Q: Give the full title of "Crop Rotation" as printed, and say what the epigraph is and what it says.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** "Crop Rotation: An Attempt at a Theory of Social Prudence" (Danish *Vexel-Driften. Forsøg til en social Klogskabslære*; Hong has "Rotation of Crops: A Venture in a Theory of Social Prudence"). The epigraph is from Aristophanes' *Plutus*, lines 189 and following: Chremylos says one finally gets sick of everything — of love, music, honour, courage, ambition, command — and the slave Karion caps each with a food, bread, sweets, cakes, figs, barley, lentils. Satiety with everything is the essay's starting note.

### Q: What principle does A open "Crop Rotation" with, and what does he say about the force such a principle has?
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** That all people are boring. He says experienced people hold that starting from a principle is very sensible, so he obliges them. The principle has the repelling force one always demands of "the negative", which is the real principle of motion; it is not merely repelling but infinitely deterrent, so whoever has it behind him has infinite momentum for making discoveries. Then the line the essay is known for: boredom is a root of all evil. The Danish says *a* root (*en Rod*), which is worth knowing because the course wording has "the root".

### Q: "Idleness is the root of all evil, so work is the cure." What does A do with that proverb, and what is the difference between idleness and boredom on his account?
**Topic:** Crop Rotation  **Lec:** reading  **Type:** critique
**A:** He calls it plebeian and replaces it. Idleness as such is not a root of evil; it is a truly divine life, as long as one is not bored. The Olympian gods were not bored and lived happily in happy idleness, and a beautiful woman who neither sews nor spins nor irons nor reads nor plays music is happy in idleness because she is not bored. Idleness is even a mark of the human: whoever has no sense for it has not risen above the animals, who must always be in motion. Boredom is the real root of evil, the thing that has to be kept away, and it is a different thing altogether: it can afflict the busiest people. The Latin proverb that idleness is the devil's pillow is right, A says, but the devil gets no time to lay his head on the pillow if one is not bored. People assume that man's destiny is to work, so their opposition is idleness against work; A assumes man's destiny is to amuse himself, so his opposition is boredom against amusement.

### Q: Why, on A's account, can work not cure boredom?
**Topic:** Crop Rotation  **Lec:** reading  **Type:** derive
**A:** Because work is the opposite of idleness, not of boredom. Work can annul idleness, since idleness is its contrary, but boredom is annulled only by amusement. The evidence A gives is that the busiest workers, the insects whirring most industriously, are the most boring people of all, and when they are not bored it is only because they have no idea what boredom is, which means boredom has not been annulled but merely not noticed. Boredom is partly an immediate genius and partly an acquired immediacy, and the English are its paradigm nation: the travelling Englishman, a heavy immovable marmot whose whole vocabulary is one interjection.

### Q: What does A say about children and nursemaids, and what point is it making?
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** Everyone recognises how ruinous boredom is where children are concerned. As long as children are amused they are good, and when they turn unruly at play it is because they are starting to be bored. So when hiring a nursemaid one looks not only for sobriety, faithfulness and decency but also, aesthetically, at whether she can amuse the children, and would dismiss her for lacking that even if she had every other virtue. The point is that the nursemaid is the only relationship in which aesthetics gets its due: nobody could get a divorce because a wife was boring, a king deposed for being boring to look at, a priest exiled for being boring to hear, a minister dismissed or a journalist executed for being boring. Habit and boredom have taken over, and that is why the world goes backwards.

### Q: Give A's history of the world as a history of boredom, through to Rome and the present day.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** The gods were bored, so they created human beings. Adam was bored alone, so Eve was created, and from that moment boredom entered the world and grew exactly as the population grew: Adam bored alone, then Adam and Eve bored together, then Adam and Eve and Cain and Abel bored as a family, then the peoples bored en masse. To amuse themselves they built a tower reaching into the clouds, an idea as boring as the tower was tall; then they were dispersed over the earth, as people now travel abroad, and went on being bored. Man stood high and fell far, first through Eve, then from the tower of Babel. What held off Rome's fall was bread and circuses. Today, instead of diversions, people hasten the fall: convening an assembly of the estates, paying off the national debt by economies. A's counter-proposal is that Denmark borrow millions and spend it on public amusement, so that everything is free, Copenhagen becomes another Athens, and the king is whoever tells the best joke.

### Q: A divides the boring into two classes. Name them, say which is which, and give the line about dying of boredom.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** The word "boring" can mean someone who bores others or someone who bores himself. Those who bore others are the plebs, the crowd, the endless rabble of humanity; those who bore themselves are the elect, the nobility. The odd thing is that those who do not bore themselves generally bore others, while those who bore themselves entertain others. The people who are never bored are the busy ones, and they are the most boring and intolerable of all. The noble class bore themselves so thoroughly that they provide diversion for the initiated even when boredom reaches its peak, at which point they either, in the passive form, die of boredom, or, in the active form, shoot themselves out of curiosity. The line is about the elect at their extreme, not a general thesis.

### Q: What is "boredom is the demonic pantheism"? Explain the phrase and the image A attaches to it.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** derive
**A:** Pantheism ordinarily means fullness, everything filled with the divine. Boredom is the reverse, built on emptiness, and is for that very reason a pantheistic category: it is everywhere, in everything, as nothing. It rests on the nothing that winds through existence, and its dizziness is the dizziness of looking down into an infinite abyss. If one remains in it as such it becomes the evil; as soon as it is annulled it is true, and it is annulled only by amusing oneself, ergo one ought to amuse oneself. A also says an eccentric diversion carries boredom inside it, which is why the diversion echoes without resonance: there is not even enough in nothing for an echo.

### Q: A distinguishes two kinds of crop rotation. Give both, say which he rejects and with what Hegelian term, and give the Nero and Marcus Aurelius contrast.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** Everyone who is bored cries for change, and A agrees, but on principle. The vulgar, inartistic method is changing the soil: tired of the country you move to the capital, tired of your country you go abroad, "tired of Europe" you go to America, then you dream of travelling from star to star; or tired of eating off porcelain you eat off silver, then gold, then you burn half of Rome to see Troy burn. A calls this "the bad infinity", Hegel's term for an endless series that never arrives, and says the method cancels itself. What did Nero achieve? The emperor Antoninus, Marcus Aurelius, was wiser: it is in your power to live again, see things again as you once saw them, that is what living again is. A's own method is the true crop rotation, keeping the soil and changing the method of cultivation and the kind of crop.

### Q: State A's principle of limitation, the examples he gives for it, and the pair of words that names the contrast.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** The principle of limitation is "the only saving principle in the world": the more one limits oneself, the more inventive one becomes. A solitary prisoner for life is extremely inventive, and a spider can be great entertainment to him. Schooldays, when teachers are chosen without aesthetic regard and are therefore boring: catching a fly and keeping it under a nutshell and watching it run about with it; cutting a hole in the desk, shutting a fly in and looking down at it through paper; how entertaining the monotonous dripping from the roof can be; what a thorough observer one becomes. The contrast is extensive against intensive: relief is sought not through extensity but through intensity.

### Q: Explain the art of remembering and forgetting in "Crop Rotation": hope, nil admirari, poetic remembering, enjoyment, shuttlecock, and the scissors.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** Every change of method falls under the general rule of the relation between remembering and forgetting, the two currents in which all of life moves. First throw hope overboard: only then does one begin to live artistically, since as long as one hopes one cannot limit oneself. Hope was one of Prometheus's dubious gifts; instead of the immortals' foreknowledge he gave men hope. Forgetting is an art that must be practised in advance; how one forgets depends on how one remembers, and that on how one experiences. So *nil admirari*, wonder at nothing, is the real wisdom of life: no moment should mean so much that one cannot forget it at will, yet each should mean enough that one can recall it at will. Childhood remembers best and forgets easiest. To remember poetically is really to forget, because the experience has already shed everything painful. Never enjoy to the last drop, since then one can neither remember nor forget but is left with a surfeit; when enjoyment carries you away, stop for a moment and remember, and never set all sails. Forgetting is not forgetfulness, and it must apply to the pleasant too, since even the pleasant as past carries the unpleasantness of longing. Forgetting is the scissors with which one cuts away what one cannot use, under the highest supervision of memory; the two are identical, and that artificially produced identity is the Archimedean point from which one lifts the world. Then one can play shuttlecock with the whole of existence, and a person's elasticity is measured by his power to forget.

### Q: Name the three relationships A says to avoid, and give his reason for each.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** Friendship, marriage and an official post, because each makes one "several" and costs one's freedom. Friendship: a friend is not what philosophy calls the necessary other but the superfluous third; the ancient mark of friendship, wanting and not wanting the same things, is also extremely boring; one person can be nothing for another except in the way. Marriage: lovers promise love for ever, which is easy and means nothing, whereas "till Easter" would mean something one might keep; after a while each side discovers it is wrong and their mutual faithlessness cancels to mutual contentment, but divorce is hard, so marriage must be propped up with moral supports; and with a wife it is difficult to order travelling boots, with wife and children impossible. An official post: one becomes a tiny peg in the machine of the state, ceases to be the master of one's own cultivation, and gets a title, which one never gets rid of again. None of this means inactivity or a life without contact or without the erotic; it means always having enough speed to run from a relationship, and cultivating breadless arts intensively.

### Q: "A thinks marriage is the worst thing you can do, and if you truly loved someone you would break it off." Assess against the text.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** critique
**A:** Half right. A does say never enter marriage, that woman is and remains man's ruin as soon as one contracts a lasting relationship with her, that a woman's love is only pretence and weakness, and that a young man fiery as an Arab horse is lost the moment he marries. And he does say that when two people fall in love and sense they are destined for each other, the thing is to have the courage to break off, since by continuing there is everything to lose and nothing to gain, which is a paradox for feeling but not for the understanding. What he does not say is "if you truly loved them". His ground is not love but the erotic's proper form: it should have infinity, but poetic infinity, which can be bounded in an hour as easily as in a month, and it requires using moods to produce inexhaustible combinations. The reason is aesthetic self-preservation, not the beloved's good. And all of it is A's, the aesthete's, position; Judge William's essay on the aesthetic validity of marriage in volume 2 is the direct reply.

### Q: "The whole secret lies in arbitrariness." Explain, with A's examples.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** recall
**A:** Arbitrariness is A's word for the inner counterpart of the accidental outside. One enjoys not the thing itself but something quite different that one arbitrarily puts into it: watching the middle of a play, reading the third part of a book, and so getting an enjoyment the author never intended. His example is a man whose philosophical chatter he was obliged to listen to; near despair he noticed the man sweated heavily when he talked, watched the drops gather on his forehead, run down his nose and hang at the tip, and from then on could even spur him to lecture just to watch. He cites Baggesen's objection to a decent man that nothing rhymes with his name. One makes something accidental into the absolute and an object of absolute admiration, treats everything in life as a wager, and constantly changes the eye with which one sees reality; the degree of consistency shows whether one is an artist or a bungler. So one must always keep an open eye for the accidental and be ready, since the most trivial thing can by chance become rich material, while pleasures prepared a fortnight in advance mean little.

### Q: "A's solution is to embrace boredom through routine." Assess.
**Topic:** Crop Rotation  **Lec:** reading  **Type:** critique
**A:** Backwards on both halves. A does not embrace boredom: it is the root of all evil and must be annulled, and the only thing that annuls it is amusement. And routine is the thing he is fleeing. Habit is what he blames for the world's decline, and marriage is condemned partly because it lands you in a fatal continuity with custom, which is as unpredictable as wind and weather. What he proposes is change, but change of the right kind: not new soil, new places and new things, which is the bad infinity, but new methods on the same soil, the principle of limitation, intensive rather than extensive rotation, governed by the arts of remembering and forgetting and by arbitrariness. The prisoner with his spider is not embracing boredom; he is defeating it with almost nothing.
